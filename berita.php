...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="532" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td style="font-family: Arial, Helvetica, sans-serif; color: #000; font-size: 12px;"><?php echo $row_Recordset1['sinopsis']; ?></td>
    </tr>
    <tr>
      <td style="font-family: Arial, Helvetica, sans-serif"><a href="berita1.php?judul=<?php echo $row_Recordset1['judul']; ?>">Baca Selengkapnya.........</a></td>
    </tr>
  </table>
