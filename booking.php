...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO booking (kode_booking, tanggal, nama, alamat, email, telepon, kode_paket, jumlah_orang, Note) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['kode_booking'], "int"),
                       ...
                       GetSQLValueString($_POST['jumlah_orang'], "int"),
...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>PESAN TIKET</h2>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input name="telepon" type="text" id="telepon" value="" size="15" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Kode paket:</td>
...
?>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Jumlah orang:</td>
          <td><input name="jumlah_orang" type="text" id="jumlah_orang" value="" size="10" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit" onclick="MM_validateForm('nama','','R','alamat','','R','email','','RisEmail','telepon','','RisNum','jumlah_orang','','RisNum');return document.MM_returnValue" value="Kirim" /></td>
        </tr>
      </table>
