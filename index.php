...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2> PAKET TOUR</h2>
      <?php do { ?>
        <table width="556" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="10" rowspan="5" align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #000; font-weight: bold;">&nbsp;</td>
            <td width="546" align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #000; font-weight: bold;"><?php echo $row_Recordset1['Nama']; ?></td>
          </tr>
          <tr>
            <td style="font-family: Arial, Helvetica, sans-serif; color: #000; font-size: 12px;"><?php echo $row_Recordset1['Deskripsi']; ?></td>
          </tr>
          <tr>
            <td style="font-family: Arial, Helvetica, sans-serif">&nbsp;</td>
          </tr>
          <tr>
            <td style="font-family: Arial, Helvetica, sans-serif; color: #000; font-size: 12px;">Rp.<?php echo $row_Recordset1['Harga']; ?></td>
          </tr>
          <tr>
            <td style="font-family: Arial, Helvetica, sans-serif">&nbsp;</td>
          </tr>
