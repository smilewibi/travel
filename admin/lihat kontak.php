...
$query_Recordset1 = "SELECT * FROM kontak ORDER BY `no` ASC";
...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>KONTAK
    </h2>
      ...
      <?php do { ?>
        <tr>
          <td><a href="sukseshapus kontak.php?no=<?php echo $row_Recordset1['no']; ?>"><img src="../images/b_drop.png" width="16" height="16" /></a></td>
          <td><?php echo $row_Recordset1['no']; ?></td>
          <td><?php echo $row_Recordset1['nama']; ?></td>
          <td><?php echo $row_Recordset1['alamat']; ?></td>
          <td><?php echo $row_Recordset1['email']; ?></td>
          <td><?php echo $row_Recordset1['komentar']; ?></td>
        </tr>
