...
$query_Recordset1 = "SELECT * FROM booking ORDER BY tanggal ASC";
...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>PESAN TIKET
    </h2>
    <p>&nbsp;</p>
    <table border="1" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="88">nama</td>
        <td width="94">alamat</td>
        <td width="88">email</td>
        <td width="97">telepon</td>
        <td width="114">kode_paket</td>
        <td width="127">jumlah_orang</td>
        <td width="81">Note</td>
      </tr>
      <?php do { ?>
        <tr>
          <td><a href="sukseshapus booking.php?kode_booking=<?php echo $row_Recordset1['kode_booking']; ?>"><img src="../images/b_drop.png" width="16" height="16" /></a></td>
          <td><?php echo $row_Recordset1['kode_booking']; ?></td>
          <td><?php echo $row_Recordset1['tanggal']; ?></td>
          <td><?php echo $row_Recordset1['nama']; ?></td>
          <td><?php echo $row_Recordset1['alamat']; ?></td>
          <td><?php echo $row_Recordset1['email']; ?></td>
          <td><?php echo $row_Recordset1['telepon']; ?></td>
          <td><?php echo $row_Recordset1['kode_paket']; ?></td>
          <td><?php echo $row_Recordset1['jumlah_orang']; ?></td>
