...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO berita (ID_berita, tanggal, sinopsis, judul, isi) VALUES (%s, %s, %s, %s, %s)",
...
mysql_select_db($database_webku, $webku);
$query_Recordset1 = "SELECT ID_berita, tanggal, sinopsis, judul, isi FROM berita ORDER BY ID_berita ASC";
...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>TAMBAH BERITA</h2>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">ID berita:</td>
          <td><input name="ID_berita" type="text" id="ID_berita" value="" size="5" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Sinopsis:</td>
          <td><textarea name="sinopsis" cols="50" rows="5" id="sinopsis"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Judul:</td>
          <td><input name="judul" type="text" id="judul" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Isi:</td>
          <td><textarea name="isi" cols="50" rows="5" id="isi"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
          <td><input type="submit" onclick="MM_validateForm('ID_berita','','R','judul','','R','sinopsis','','R','isi','','R');return document.MM_returnValue" value="Simpan" /></td>
        </tr>
      </table>
      <input type="hidden" name="tanggal" value="<?php include('waktu.php'); ?>" />
