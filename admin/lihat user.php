...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>DAFTAR USER
    </h2>
      <table border="1" cellpadding="0" cellspacing="0">
        ...
        <?php do { ?>
          <tr>
            <td><a href="tambah user.php"><img src="../images/tambah.jpg" alt="" width="16" height="16" /></a></td>
            <td><a href="edit user.php?UserId=<?php echo $row_Recordset1['UserId']; ?>"><img src="../images/b_edit.png" alt="" width="16" height="16" /></a></td>
            <td><a href="sukseshapus user.php?kode_pengguna=<?php echo $row_Recordset1['kode_pengguna']; ?>"><img src="../images/b_drop.png" alt="" width="16" height="16" /></a></td>
            <td><?php echo $row_Recordset1['kode_pengguna']; ?></td>
            <td><?php echo $row_Recordset1['nama_pengguna']; ?></td>
