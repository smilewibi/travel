...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>DAFTAR TOUR
    </h2>
      ...
      <?php do { ?>
        <tr>
          <td><a href="tambah user.php"><img src="../images/tambah.jpg" width="16" height="16" /></a></td>
          <td><a href="edit tur.php?Kode_paket=<?php echo $row_Recordset1['Kode_paket']; ?>"><img src="../images/b_edit.png" width="16" height="16" /></a></td>
          <td><a href="hapus tur.php?Kode_paket=<?php echo $row_Recordset1['Kode_paket']; ?>"><img src="../images/b_drop.png" width="16" height="16" /></a></td>
          <td><?php echo $row_Recordset1['Kode_paket']; ?></td>
          <td><?php echo $row_Recordset1['Nama']; ?></td>
          <td><?php echo $row_Recordset1['Deskripsi']; ?></td>
