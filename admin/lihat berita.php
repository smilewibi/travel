...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>BERITA
    </h2>
      ...
      <?php do { ?>
        <tr>
          <td><a href="tambah berita.php"><img src="../images/tambah.jpg" width="16" height="16" /></a></td>
          <td><a href="edit berita.php?ID_berita=<?php echo $row_Recordset1['ID_berita']; ?>"><img src="../images/b_edit.png" width="16" height="16" /></a></td>
          <td><a href="hapus berita.php?ID_berita=<?php echo $row_Recordset1['ID_berita']; ?>"><img src="../images/b_drop.png" width="16" height="16" /></a></td>
          <td><?php echo $row_Recordset1['ID_berita']; ?></td>
          <td><?php echo $row_Recordset1['tanggal']; ?></td>
          <td><?php echo $row_Recordset1['sinopsis']; ?></td>
