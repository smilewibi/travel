...
if (isset($_GET['kode_pengguna'])) {
  $colname_Recordset1 = $_GET['kode_pengguna'];
}
mysql_select_db($database_webku, $webku);
$query_Recordset1 = sprintf("SELECT * FROM pengguna WHERE kode_pengguna = %s", GetSQLValueString($colname_Recordset1, "text"));
...
if (isset($_POST['User_Id'])) {
  $colname_Recordset1 = $_POST['User_Id'];
}
mysql_select_db($database_webku, $webku);
...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>HAPUS USER
    </h2>
      <form id="form1" name="form1" method="post" action="sukseshapus user.php?kode_pengguna=<?php echo $row_Recordset1['kode_pengguna']; ?>">
        <p>
        <input name="UserId" type="text" id="UserId" value="<?php echo $row_Recordset1['kode_pengguna']; ?>" />
      </p>
      <p>
        <input name="textfield2" type="text" id="textfield2" value="<?php echo $row_Recordset1['nama_pengguna']; ?>" />
      </p>
      <p>
        <input name="textfield3" type="text" id="textfield3" value="<?php echo $row_Recordset1['password']; ?>" />
      </p>
      <p>
        <input name="textfield4" type="text" id="textfield4" value="<?php echo $row_Recordset1['nama_lengkap']; ?>" />
      </p>
      <p>
