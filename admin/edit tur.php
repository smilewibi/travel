...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>EDIT TOUR</h2>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><textarea name="Deskripsi" cols="50" rows="5"><?php echo htmlentities($row_Recordset1['Deskripsi'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Harga:</td>
          <td><input type="text" name="Harga" value="<?php echo htmlentities($row_Recordset1['Harga'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
