...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO paket_tur (Kode_paket, Nama, Deskripsi, Harga) VALUES (%s, %s, %s, %s)",
...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>TAMBAH TOUR</h2>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Kode_paket:</td>
          <td><input name="Kode_paket" type="text" id="Kode_paket" value="" size="6" maxlength="6" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Nama:</td>
          <td><input name="Nama" type="text" id="Nama" value="" size="50" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Deskripsi:</td>
          <td><textarea name="Deskripsi" cols="50" rows="5" id="Deskripsi"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Harga:</td>
          <td><input name="Harga" type="text" id="Harga" value="" size="10" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit" onclick="MM_validateForm('Kode_paket','','R','Nama','','R','Harga','','RisNum','Deskripsi','','R');return document.MM_returnValue" value="Simpan" /></td>
        </tr>
      </table>
