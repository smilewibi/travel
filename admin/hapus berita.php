...
$query_Recordset1 = sprintf("SELECT * FROM berita WHERE ID_berita = %s", GetSQLValueString($colname_Recordset1, "text"));
...
<table width="754" height="705" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="132" colspan="5" align="left" valign="top" bgcolor="#FFFFFF" class="judul"><h2>HAPUS BERITA</h2>
      <form id="form1" name="form1" method="post" action="sukseshapus berita.php?ID_berita=<?php echo $row_Recordset1['ID_berita']; ?>">
        <p>
          <input name="textfield" readonly="1" type="text" id="textfield" value="<?php echo $row_Recordset1['ID_berita']; ?>" />
        </p>
        <p>
          <input name="textfield2" readonly="1" type="text" id="textfield2" value="<?php echo $row_Recordset1['tanggal']; ?>" />
        </p>
        <p>
          <textarea name="textarea" readonly="1" id="textarea" cols="45" rows="5"><?php echo $row_Recordset1['sinopsis']; ?></textarea>
        </p>
        <p>
          <input name="textfield3" readonly="1" type="text" id="textfield3" value="<?php echo $row_Recordset1['judul']; ?>" />
        </p>
        <p>
          <textarea name="textarea2" readonly="1" id="textarea2" cols="45" rows="5"><?php echo $row_Recordset1['isi']; ?></textarea>
        </p>
        <p>
